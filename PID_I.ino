...
#define _DIST_ALPHA 0.0  //[3054] 센서 보정정도
          // [3131] EMA필터값
// Servo ran
#define _DUTY_MIN 1500    // [3052] 서보의 최소각도를 microseconds로 표현
...
#define _SERVO_SPEED 1000   //[3064]서보 속도를 30으로
...
#define _KI 0.0025 // [2635] I 이득 비율
#define _KD 20.0 // [2635] D 이득 비율

//iterm 최대최소
//#define _ITERM_MAX 1000
//#define _ITERM_MIN 300
...
#define EMA_ALPHA 0.45  // EMA 필터 값을 결정하는 ALPHA 값. 작성자가 생각하는 최적값임.
...
// Distance sensor
float dist_target = 255; // [1234] location to send the ball
float dist_raw, dist_ema;// [3070] 거리와 노이즈 필터 적용 후 거리를 저장하기 위한 변수
const float coE[] = {0.0000595, -0.0237001, 4.0448595, -58.0012261};
...
void loop() {
    ...
    if(event_dist) {
        ...
        //dist_raw =filtered_ir_distance(); // [_2635] 센서 값 받아와서 변수에 저장
